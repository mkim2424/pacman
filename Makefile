...
DEMOS = bounce gravity pacman nbodies damping
# List of C files in "libraries" that we provide
STAFF_LIBS = test_util sdl_wrapper
# List of C files in "libraries" that you will write
STUDENT_LIBS = vector list polygon body scene forces color
# removed color from STUDENT_LIBS by James 4/29 at 2:43 PM
